...
import { CATEGORIES, UNITS, STORES } from '../types/shopping';
...
export default function ShoppingListFilters({
  ...
  const updatePriceRange = (index: number, value: string) => {
            ...
            <View style={styles.priceRangeContainer}>
              <View style={styles.priceInput}>
                ...
                <TextInput
                  ...
                  value={tempFilters.priceRange[0].toString()}
                  onChangeText={(text) => updatePriceRange(0, text)}
              ...
              <View style={styles.priceInput}>
                ...
                <TextInput
                  style={styles.priceInputField}
                  value={tempFilters.priceRange[1].toString()}
                  onChangeText={(text) => updatePriceRange(1, text)}
                  keyboardType="numeric"
                  placeholder="100"
                  placeholderTextColor="#999"
                />
            ...
            <View style={styles.unitsGrid}>
              {UNITS.map((unit) => (
                <Pressable
                  ...
                  style={[
                    styles.unitChip,
                    tempFilters.selectedUnits.includes(unit) && styles.unitChipSelected,
                  ]}
                  onPress={() => toggleUnit(unit)}
                >
                  <Text style={[
                    styles.unitChipText,
                    tempFilters.selectedUnits.includes(unit) && styles.unitChipTextSelected,
                  ]}>
                    {unit}
                  </Text>
                </Pressable>
